...
ladies_grandchild_array = [
                           [{name:"Tシャツ/カットソー(半袖/袖なし)",item_size_id:f_size_parent.id},
                            {name:"Tシャツ/カットソー(七分/長袖)",item_size_id:f_size_parent.id},
                            {name: "シャツ/ブラウス(半袖/袖なし)", item_size_id: f_size_parent.id},
                            {name: "ポロシャツ", item_size_id: f_size_parent.id},
                            {name: "キャミソール", item_size_id: f_size_parent.id},
                            {name: "タンクトップ", item_size_id: f_size_parent.id},
                            {name: "ホルターネック", item_size_id: f_size_parent.id},
                            {name: "ニット/セーター", item_size_id: f_size_parent.id},
                            {name: "チュニック", item_size_id: f_size_parent.id},
                            {name: "カーディガン/ボレロ", item_size_id: f_size_parent.id},
                            {name: "アンサンブル", item_size_id: f_size_parent.id},
                            {name: "ベスト/ジレ", item_size_id: f_size_parent.id},
                            {name: "パーカー", item_size_id: f_size_parent.id}], 
                           [{name:"テーラージャケット",item_size_id:f_size_parent.id},
                            {name:"ノーカラージャケット",item_size_id:f_size_parent.id},
                            {name:"レザージャケット",item_size_id:f_size_parent.id},
                            {name:"ダウンジャケット",item_size_id:f_size_parent.id},
                            {name:"ライダースジャケット",item_size_id:f_size_parent.id},
                            {name:"ミリタリージャケット",item_size_id:f_size_parent.id},
                            {name:"ダウンベスト",item_size_id:f_size_parent.id},
                            {name:"ジャンバー/ブルゾン",item_size_id:f_size_parent.id},
                            {name:"ポンチョ",item_size_id:f_size_parent.id},
                            {name:"ロングコート",item_size_id:f_size_parent.id},
                            {name:"トレンチコート",item_size_id:f_size_parent.id},
                            {name:"ダッフルコート",item_size_id:f_size_parent.id},
                            {name:"ビーコート",item_size_id:f_size_parent.id}],
                           [{name:"デニム/ジーンズ",item_size_id:f_size_parent.id},
                            {name:"ショートパンツ",item_size_id:f_size_parent.id},
                            {name:"カジュアルパンツ",item_size_id:f_size_parent.id},
                            {name:"ハーフパンツ",item_size_id:f_size_parent.id},
                            {name:"チノパン",item_size_id:f_size_parent.id},
                            {name:"ワークパンツ/カーゴパンツ",item_size_id:f_size_parent.id},
                            {name:"クロップドパンツ",item_size_id:f_size_parent.id},
                            {name:"サロペット/オーバーホール",item_size_id:f_size_parent.id},
                            {name:"デニム/ジーンズ",item_size_id:f_size_parent.id},
                            {name:"オールインワン",item_size_id:f_size_parent.id},
                            {name:"サルエルパンツ",item_size_id:f_size_parent.id},
                            {name:"ガチョウパンツ",item_size_id:f_size_parent.id},
                            {name:"その他",item_size_id:f_size_parent.id}],
                           [{name:"ミニスカート",item_size_id:f_size_parent.id},
                            {name:"ひざ丈スカート",item_size_id:f_size_parent.id},
                            {name:"ロングスカート",item_size_id:f_size_parent.id},
                            {name:"キュロット",item_size_id:f_size_parent.id},
                            {name:"その他",item_size_id:f_size_parent.id}],
                           [{name:"ミニワンピース",item_size_id:f_size_parent.id},
                            {name:"ひざ丈ワンピース",item_size_id:f_size_parent.id},
                            {name:"ロングワンピース",item_size_id:f_size_parent.id},
                            {name:"その他",item_size_id:f_size_parent.id}],
                           [{name:"ハイヒール/バンプス",item_size_id:shoes_size_parent.id},
                            {name:"ブーツ",item_size_id:shoes_size_parent.id},
                            {name:"サンダル",item_size_id:shoes_size_parent.id},
                            {name:"スニーカー",item_size_id:shoes_size_parent.id},
                            {name:"ミュール",item_size_id:shoes_size_parent.id},
                            {name:"モカシン",item_size_id:shoes_size_parent.id},
                            {name:"ローファー",item_size_id:shoes_size_parent.id},
                            {name:"革靴",item_size_id:shoes_size_parent.id},
                            {name:"フラットシューズ/バレエシューズ",item_size_id:shoes_size_parent.id},
                            {name:"長靴/レインシューズ",item_size_id:shoes_size_parent.id},
                            {name:"その他",item_size_id:shoes_size_parent.id}],
                           [{name:"パジャマ",item_size_id:f_size_parent.id},
                            {name:"ルームウェア",item_size_id:f_size_parent.id}],
                           ...
                           [{name:"ハンドバッグ"},{name:"トートバッグ"},{name:"エコバッグ"},{name:"リュック/バックパック"},{name:"ボストンバッグ"},{name:"スポーツバッグ"},{name:"ショルダーバッグ"},{name:"クラッチバッグ"},{name:"ポーチ/バニティ"},{name:"ボディバッグ/ウェストバッグ"},{name:"マザーズバッグ"},{name:"メッセンジャーバッグ"}],
                           [{name:"ネックレス"},{name:"ブレスレット"},{name:"バングル/リストバンド"},{name:"リング"}],
                           [{name:"ヘアゴム/シュシュ"},{name:"ヘアバンド/カチューシャ"},{name:"ヘアピン"}],
                           [{name:"長財布"},{name:"折り財布"},{name:"コインケース/小銭いれ"},{name:"名刺入れ/定期入れ"}],
                           [{name:"腕時計"},{name:"腕時計（デジタル）"},{name:"ラバーベルト"}]
                          ]
parent = Category.create(name: 'レディース')
ladies_child_array.each_with_index do |child, i|
  child = parent.children.create(name:child)
  ladies_grandchild_array[i].each_with_index do |grandchild, i|
...
mens_grandchild_array = [
                          ...
                          ['トランクス','ボクサーパンツ','その他','toma','aaaaa11111'],
                          []
                        ]
...
# ベビー・キッズ
babykids_child_array = ['ベビー服(女の子用)~95cm','ベビー服(男の子用)~95cm','ベビー服(男女兼用)~95cm','キッズ服(女の子用)100cm~','キッズ服(男の子用)100cm~','キッズ服(男女兼用)100cm~','キッズ靴','子供用ファッション小物','おむつ/トイレ/バス','外出/移動用品','授乳/食事','ベビー家具/寝具/室内用品','おもちゃ','行事/記念品']
...
# 本・音楽・ゲーム
goods_child_array = ['本','漫画','雑誌','CD','DVD/ブルーレイ','レコード','テレビゲーム']
goods_grandchild_array = [
                            ['文学','人文/小説','ノンフィクション/教養','地図/旅行ガイド','ビジネス/経済','健康/医学','コンピュータ/IT','趣味/スポーツ/実用','住まい/暮らし/子育て','アート/エンタメ','洋書','絵本','参考書','その他'], 
                            ['全巻セット','少女漫画','少年漫画','青年漫画','女性漫画','同人誌','その他'],
...
goods_child_array.each_with_index do |child, i|
  child = parent.children.create(name: child)
  goods_grandchild_array[i].each do |grandchild|
    child.children.create(name: grandchild)
  end
end
...
toy_grandchild_array = [
                          ...
                          ['画材','額縁','その他'], 
                          ['トランプ/UNO','カルタ/百人一首','ダーツ','ビリヤード','麻雀','パズル/ジグソーパズル','囲碁/将棋','オセロ/チェス','人生ゲーム','野球/サッカーゲーム','スポーツ','三輪車/乗り物','ヨーヨー','模型製作品']
                        ]
...
beauty_grandchild_array = [
                            ...
                            ['ネイルカラー','カラージュル','ネイルベースコート/トップコート','ネイルアート用品','ネイルパーツ','ネイルチップ/付け爪','手入れ用具','除光液','その他'], 
                            ['香水(女性用)','香水(男性用)','ユニセックス','ボディミスト','その他'], 
                            ['化粧水/ローション','乳液/ミルク','美容液','フェイスクリーム','洗顔料','クレンジング/メイク落とし','パック/フェイスマスク','ジェル/導入液','アイケア','リップケア','トライアルセット/サンプル','洗顔グッズ','その他'], 
                            ...
                            ['エッセンシャルオイル','芳香器','お香/香炉','キャンドル','リラクゼーション','その他'], 
...
appliances_grandchild_array = [
                                ...
                                ['テレビ','プロジェクター','ブルーレイコーダー','DVDレコーダー','映像用ケーブル','その他'], 
                                ['ポータブルプレイヤー','イヤホン','ヘッドフォン','アンプ','スピーカー','ケーブル/シールド','ラジオ','その他'], 
...
sport_grandchild_array = [
                            ...
                            ['ウエア','シューズ','グローブ','バット','アクセサリー','防具','練習機器','記念グッズ','応援グッズ','その他'], 
                            ['ウエア','シューズ','ボール','アクセサリー','記念グッズ','応援グッズ','その他'], 
                            ['ラケット(硬式用)','ラケット(軟式用)','ウエア','シューズ','ボール','アクセサリー','記念グッズ','応援グッズ','その他'], 
...
# 自動車・オートバイ
moto_child_array = ['自動車本体','自動車タイヤ/ホイール','自動車パーツ','自動車アクセサリー','オートバイ本体','オートバイパーツ','オートバイアクセサリー','その他']
moto_grandchild_array = [
                          ['国内自動車本体','外国自動車本体'], 
                          ...
                          ['ホンダ','カワサキ','ヤマハ','スズキ','BMW','ドゥカティ','アプリリア','KTM','その他'], 
...
moto_child_array.each_with_index do |child, i|
  child = parent.children.create(name: child)
  moto_grandchild_array[i].each do |grandchild|
    child.children.create(name: grandchild)
  end
end
...
other_grandchild_array = [
                          [], 
                          ['ペットフード','犬用品','猫用品','魚用品/水草','爬虫類/両生類用品','かご/おり','鳥用品','虫類用品','その他'],
                          ...
                          ['雑貨','工芸品','家具','印刷物','その他'], 
                          ['筆記具','ノート/メモ帳','テープ/マスキングテープ','カレンダー/スケジュール','アルバム/スクラップ','はさみ/カッター','カードホルダー/名刺管理','のり/ホッチキス','その他'],
